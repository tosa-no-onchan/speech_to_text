...
#    Sep 15, 2023 03:57:05 PM JST  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button_ok.place(relx=0.105, rely=0.571, height=33, width=73)
        ...
        self.Button_remove.place(relx=0.105, rely=0.706, height=33, width=73)
        ...
        self.Button_wavsurfer.place(relx=0.482, rely=0.461, height=33, width=103)
        ...
        self.Button_wav_to_mp3.place(relx=0.487, rely=0.692, height=33
                , width=103)
        ...
        self.Button_recovery.place(relx=0.488, rely=0.829, height=33, width=99)
        ...
        self.Label3.place(relx=0.538, rely=0.543, height=54, width=219)
        self.Label3.configure(activebackground="#f9f9f9")
        self.Label3.configure(anchor='w')
        self.Label3.configure(compound='left')
        self.Label3.configure(justify='left')
        self.Label3.configure(text='''1. Convert mp3 to wav.
2. Open wav with wavsurfer.
    and save wav by overwrie''')
        self.Label4 = tk.Label(self.top)
        self.Label4.place(relx=0.545, rely=0.765, height=23, width=229)
        ...
        self.Label7.place(relx=0.122, rely=0.776, height=21, width=179)
