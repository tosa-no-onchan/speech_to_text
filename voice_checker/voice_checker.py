...
#    Sep 20, 2023 01:59:24 PM JST  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.088, rely=0.068, height=23, width=79)
        self.Label1.configure(activebackground="#f9f9f9")
        self.Label1.configure(anchor='w')
        self.Label1.configure(compound='left')
        self.Label1.configure(text='''File Name''')
        self.Label2 = tk.Label(self.top)
        self.Label2.place(relx=0.097, rely=0.149, height=24, width=39)
        self.Label2.configure(activebackground="#f9f9f9")
        self.Label2.configure(anchor='w')
        self.Label2.configure(compound='left')
        self.Label2.configure(text='''Text''')
        self.Text1 = tk.Text(self.top)
        self.Text1.place(relx=0.1, rely=0.209, relheight=0.163, relwidth=0.843)
        self.Text1.configure(background="white")
        self.Text1.configure(font="TkTextFont")
        self.Text1.configure(selectbackground="#c4c4c4")
        self.Text1.configure(wrap="word")
        self.Entry1 = tk.Entry(self.top)
        self.Entry1.place(relx=0.252, rely=0.068, height=23, relwidth=0.46)
        ...
        self.Button_ok.place(relx=0.1, rely=0.547, height=33, width=73)
        ...
        self.Button_remove.place(relx=0.1, rely=0.821, height=33, width=73)
        ...
        self.Button_wavsurfer.place(relx=0.482, rely=0.419, height=33, width=103)
        ...
        self.Button_wav_to_mp3.place(relx=0.482, rely=0.624, height=33
                , width=103)
        ...
        self.Button_recovery.place(relx=0.482, rely=0.793, height=33, width=99)
...
2.If -org.mp3 there,
  recovery mp3 from -org.mp3''')
        ...
        self.Label8.place(relx=0.127, rely=0.771, height=22, width=109)
